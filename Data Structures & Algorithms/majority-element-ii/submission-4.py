    ...
    def majorityElement(self, nums: List[int]) -> List[int]:
        ...
        for num in nums:
            ...
            # open slot
                ...
                candidate_b = num
                cnt_b += 1
            # if it does not match a curr candidate and both candidates are full then it is a new number
            else:
                cnt_a -= 1
                cnt_b -= 1
                if cnt_a == 0:
        ...
        # reset and take actual counts - cnt before tracks including cancellations 
        cnt_a = cnt_b = 0
        for num in nums:
            if num == candidate_a:
                cnt_a += 1
